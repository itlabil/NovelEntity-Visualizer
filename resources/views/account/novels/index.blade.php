...
<div class="mb-8" x-data>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl sm:text-xl font-bold text-gray-900">Manajemen Novel</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden mt-5">
        ...
        <div class="px-6 py-3 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                @can('novels.create')
                    <a href="{{ route('account.novels.create') }}"  class="inline-flex text-sm items-center px-3 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
