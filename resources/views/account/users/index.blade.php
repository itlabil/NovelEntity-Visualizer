...
<div class="mb-8" x-data>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl sm:text-xl font-bold text-gray-900">User Management</h2>
            <p class="text-gray-600 mt-1 italic">Manage your users and their information</p>
        </div>
    </div>
