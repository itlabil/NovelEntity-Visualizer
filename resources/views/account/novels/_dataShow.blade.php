...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('account.novels.show', $novel->id) }}",
            ...
            columns: [
                ...
                { data: 'main_name', name: 'main_name', className: 'px-6 py-4'},
                { data: 'type', name: 'type', className: 'px-6 py-4'},
                { data: 'gender', name: 'gender', className: 'px-6 py-4'},
        ...
        initBulkDelete({
            table: table, 
            route: "{{ route('account.entities.bulkDelete') }}",
            checkboxClass: '.entity-checkbox'
        });
